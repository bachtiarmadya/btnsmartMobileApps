...
public class ServiceProgress extends Fragment {

    public ServiceProgress() {
        // Required empty public constructor
    }

    public static ServiceProgress newInstance(String param1, String param2) {
        ServiceProgress fragment = new ServiceProgress();
